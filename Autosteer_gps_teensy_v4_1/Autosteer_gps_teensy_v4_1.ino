...
/*****************************************************************/
// UM982 Support
bool useUM982 = false; // если  "true" то работает дуал (паоги)если "false" работает панда and udpPassthrough is "false" .
...
void setup()
{
  ...
  Serial5.begin(115200);                                                                   // 115200 бод, 8N1 по умолчанию MaixCam
